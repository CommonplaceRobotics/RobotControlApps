...
from .DataTypes.ProgramVariable import ProgramVariable, NumberVariable, PositionVariable
...
from .rpc.robotcontrolapp_pb2_grpc import RobotControlAppStub
        ...
        for grpcVariable in self.__grpcStub.GetProgramVariables(request):
            if grpcVariable.HasField("number"):
                ...
                if grpcVariable.position.HasField("robot_joints"):
                    resultVariables[grpcVariable.name] = MakePositionVariableJoint(
                        grpcVariable.name,
                    ...
                    resultVariables[grpcVariable.name] = MakePositionVariableBoth(
                        grpcVariable.name,
                        cartesian,
                    ...
                    resultVariables[grpcVariable.name] = MakePositionVariableCartesian(
                        grpcVariable.name,
                        cartesian,
                        grpcVariable.position.external_joints,
                    )
